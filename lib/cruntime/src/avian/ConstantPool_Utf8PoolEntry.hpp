...
class avian::ConstantPool_Utf8PoolEntry
...
protected:
    void ctor(::java::lang::String* data);
...
public:
    ...
    // Generated
    ConstantPool_Utf8PoolEntry(::java::lang::String* data);
protected:
    ConstantPool_Utf8PoolEntry(const ::default_init_tag&);
