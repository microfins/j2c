...
class avian::ConstantPool_StringPoolEntry
...
public:
    ...
    // Generated
    ConstantPool_StringPoolEntry(int32_t valueIndex);
protected:
    ConstantPool_StringPoolEntry(const ::default_init_tag&);
