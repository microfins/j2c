...
class avian::ConstantPool_FieldRefPoolEntry
...
public:
    ...
    // Generated
    ConstantPool_FieldRefPoolEntry(int32_t classIndex, int32_t nameAndTypeIndex);
protected:
    ConstantPool_FieldRefPoolEntry(const ::default_init_tag&);
